...
/**
 * Send an interactive CTA-URL button (one tappable button that opens a
 * link) from the engine. Free-form / session message — delivers only
 * inside the 24h window. Mirrors engineSendText: same account lookup,
 * phone-variant retry and messages persistence.
 */
