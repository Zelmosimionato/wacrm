// ⛔ O agrupamento esperado e o BRASILEIRO (1.234). Estas afirmacoes diziam
// "1,234" e so passavam porque a maquina do teste estava em ingles — o
// formatador usava o locale do ambiente. Ver LOCALE em currency.ts.
